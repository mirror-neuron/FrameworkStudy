...
INSERT INTO TBL_MEMBERLIST(ID, PW, NAME, TEL, EMAIL)
VALUES('suyeon', CRYPTPACK.ENCRYPT('java006$', 'suyeon'), '조수연', '010-1111-1111', 'suyeon@test.com');
--> 한 줄 구성
INSERT INTO TBL_MEMBERLIST(ID, PW, NAME, TEL, EMAIL) VALUES('suyeon', CRYPTPACK.ENCRYPT('java006$', 'suyeon'), '조수연', '010-1111-1111', 'suyeon@test.com')
;
--==>> 1 행 이(가) 삽입되었습니다.
